...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt->execute([$nuevoNick, $nuevoNombre, $id, $nuevoApellido, $nuevoEmail, $nuevoPassword]);
    ...
    <div class="container mt-5">
        ...
        <form method="post" action="">
            ...
            <div class="form-group">
                ...
                <textarea id="nuevoApellido" name="nuevoApellido" class="form-control" required><?php echo $usuario['APELLIDOS']; ?></textarea>
            </div>
            <div class="form-group">
